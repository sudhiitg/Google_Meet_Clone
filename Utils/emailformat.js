...
exports.emailFormat = function (userDetails) {
    const name = userDetails.sender.displayName;
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="es-infoblock esd-block-text es-m-txt-c" align="left">
                                                                                            <p style="font-family: arial, helvetica\ neue, helvetica, sans-serif;">You have a meeting scheduled!</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p40t es-p10b es-p40r es-p40l" align="left" bgcolor="transparent">
                                                                                            ...
                                                                                            <p style="color: #999999;">${name} scheduled a meeting for 15 minutes from now!</p>
